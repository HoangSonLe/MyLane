  ...
  const inner = (
    <div
      className={[
        ...
        // minimum 44px tap target via py-3 (12px) + content ~20px = 44px total
        ...
        .join(' ')}
    >
      {/* Icon — no container in list rows (I4). Danger gets a subtle inline tint via text color only. */}
      <div
        className={[
      ...
      <div className="min-w-0 flex-1">
        {skeleton ? (
          ...
          <>
            {/* body step: 15px / font-medium (R15) */}
            <p
              className={[
